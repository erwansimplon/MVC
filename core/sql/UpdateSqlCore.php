<?php
	...
	class UpdateSqlCore
	{
		 ...
		 * @return $this
		 */
		public function update($table, $alias = false){
			
			$this->update = "UPDATE ";
			
			$this->update .= $alias ? "$table $alias"
									: "$table";
		 ...
		 * @return $this
		 */
		public function set($set_colonne){
			
			$colonne_update = array_keys($set_colonne);
			$colonne_select = array_values($set_colonne);
